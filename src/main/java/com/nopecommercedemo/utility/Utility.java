package com.nopecommercedemo.utility;

import com.nopecommercedemo.browsefactory.ManageBrowser;
...
//***************************** Is Display Methods **********************************************//
    ...
    {
        try {
            String dateName = new SimpleDateFormat("ddMMyyyy-hhmm").format(new Date());
            TakesScreenshot ts = (TakesScreenshot) driver;
            File source = ts.getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(source, new File("target/screenshots/screenShotsForEachStep/"+screenshotName + dateName + ".png"));
    ...
    public static void closeWebDriver(WebDriver driver) {
        if (driver != null) {
            try {
                ...
                System.out.println("Session not found while closing the WebDriver.");
            }
        }
    }
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) throws IOException {
        ...
        TakesScreenshot ts = (TakesScreenshot) driver;
        File source = ts.getScreenshotAs(OutputType.FILE);
        String pathname = "target/screenshots/screenShotsForFailure/" + screenshotName + dateName + ".png";
...
// After execution, you could see a folder "FailedTestsScreenshots" under screenshot folder
    ...
    public void captureScreenshot(String methodName ) {
        try {
            ...
            TakesScreenshot ts = (TakesScreenshot) driver;
            File source = ts.getScreenshotAs(OutputType.FILE);
            File destination = new File("/src/main/java/screenshots/" + methodName + ".png");
